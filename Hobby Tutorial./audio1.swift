...
struct AudioPlayerView: View {
    ...
    let fileName: String // Define a variable to hold the file name
    
    init(fileName: String) {
            self.fileName = fileName // Initialize the file name
        }
...
struct AudioPlayerView_Previews: PreviewProvider {
    static var previews: some View {
        AudioPlayerView(fileName: "afterlike")
